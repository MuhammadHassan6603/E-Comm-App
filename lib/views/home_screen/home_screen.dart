...
import 'package:ecomm/views/home_screen/components/featured_button.dart';
import 'package:ecomm/views/widgets_common/home_buttons.dart';
                      ...
                      GridView.builder(
                        ...
                        return Column(
                              ...
                              children: [
                                ...
                                const Spacer(),
                                10.heightBox,
                                "Ladies Bag".text.fontFamily(semibold).color(darkFontGrey).make(),
                                10.heightBox,
                                "\$350".text.color(redColor).fontFamily(bold).size(16).make()
                              ],
